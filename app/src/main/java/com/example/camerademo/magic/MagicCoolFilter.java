...
public class MagicCoolFilter extends GPUImageFilter{
	...
	protected void onDrawArraysPre(){
		if (this.mToneCurveTexture[0] != -1){
            ...
            Log.e("MagicCoolFilter" ,  "mToneCurveTextureUniformLocation" + mToneCurveTextureUniformLocation  + "mprogram" + mGLProgId);
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
			    ...
			    GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mToneCurveTexture[0]);
				Log.e("MagicCoolFilter", "mToneCurveTexture" + mToneCurveTexture[0]);
