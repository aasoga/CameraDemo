...
/**
 * Created by v_yanligang on 2017/5/31.
 */
...
public class CameraFilter extends BaseFilter {
    ...
    public CameraFilter(Context context) {
        super(readShaderFromRaw(context, R.raw.default_vertex), readShaderFromRaw(context, R.raw.default_fragment));
//        super();
    }
...
//        }
        ...
        GLES20.glVertexAttribPointer(mGLAttribTextureCoordinate, 2, GLES20.GL_FLOAT, false, 0, textureVerticesBuffer);
